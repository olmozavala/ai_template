...
if __name__ == '__main__':
    ...
    if (model_type == AiModels.UNET_3D_3_STREAMS) or (model_type == AiModels.UNET_3D_SINGLE):
        train_generator = my_generator.unet_3d_multi_streams(input_folder=input_folder,
        ...
        val_generator = my_generator.unet_3d_multi_streams(input_folder=input_folder,
